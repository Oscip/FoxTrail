...
const posten = [
    {
        id: 1,
        frage: "Suchen Sie die Jahreszahl auf dem Brunnen. Der Bäcker ist 200 Jahr jünger als der Brunnen. Wie alt ist er?",
        loesung: "1824",
        hinweis: "Der Bäcker war die ganze Nacht mit seinem Lernenden am Brotbacken",
    },
    {
        id: 2,
        frage: "Wie viele Treppenstufen führen zur alten Stadtmauer beim Lindbergpark?",
        loesung: "43",
        hinweis: "Die Stadtmauer wurde zur Verteidigung genutzt – hier wurde einst gekämpft.",
    },
];
            ...
            {aktuell < posten.length ? (
                <Card className="shadow-xl rounded-2xl p-4">
                    <CardContent className="space-y-4">
                        <h2 className="text-xl font-semibold">Posten {posten[aktuell].id}</h2>
